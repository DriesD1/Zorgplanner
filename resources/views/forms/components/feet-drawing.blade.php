...
>
    <div
            ...
            start(e) {
                ...
                if (this.mode === 'text') {
                    ...
                    if (text) {
                        ...
                        this.drawCtx.font = 'bold 20px sans-serif';
        ...
        {{-- HIER ZIT DE OPLOSSING: We luisteren naar het event uit CreateClient.php --}}
        x-on:reset-drawing.window="reset()"
    ...
    >
        <div class="flex flex-wrap items-center gap-3 p-2 bg-gray-100 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
            ...
            <div class="flex items-center bg-white dark:bg-gray-700 rounded-lg shadow-sm p-1">
                <button type="button" @click="mode = 'pen'" :class="mode === 'pen' ? 'bg-blue-100 text-blue-600 dark:bg-blue-900 dark:text-blue-300' : 'text-gray-500 dark:text-gray-300'" class="p-2 rounded transition hover:bg-gray-100 dark:hover:bg-gray-600" title="Pen">
                ...
                <button type="button" @click="setTextMode()" :class="mode === 'text' ? 'bg-blue-100 text-blue-600 dark:bg-blue-900 dark:text-blue-300' : 'text-gray-500 dark:text-gray-300'" class="p-2 rounded transition hover:bg-gray-100 dark:hover:bg-gray-600 font-bold font-serif" title="Tekst">T</button>
                <button type="button" @click="setEraser()" :class="mode === 'eraser' ? 'bg-blue-100 text-blue-600 dark:bg-blue-900 dark:text-blue-300' : 'text-gray-500 dark:text-gray-300'" class="p-2 rounded transition hover:bg-gray-100 dark:hover:bg-gray-600" title="Gom">
            ...
            <div class="flex items-center bg-white dark:bg-gray-700 rounded-lg shadow-sm p-1 gap-2 px-3">
                <button type="button" @click="setThickness(2)" :class="currentThickness === 2 ? 'bg-gray-200 ring-1 ring-gray-400 dark:bg-gray-600 dark:ring-gray-500' : 'hover:bg-gray-100 dark:hover:bg-gray-600'" class="w-6 h-6 flex items-center justify-center rounded transition"><svg width="6" height="6"><circle cx="3" cy="3" r="2" fill="currentColor" class="text-gray-700 dark:text-gray-200"/></svg></button>
                <button type="button" @click="setThickness(6)" :class="currentThickness === 6 ? 'bg-gray-200 ring-1 ring-gray-400 dark:bg-gray-600 dark:ring-gray-500' : 'hover:bg-gray-100 dark:hover:bg-gray-600'" class="w-6 h-6 flex items-center justify-center rounded transition"><svg width="10" height="10"><circle cx="5" cy="5" r="4" fill="currentColor" class="text-gray-700 dark:text-gray-200"/></svg></button>
                <button type="button" @click="setThickness(12)" :class="currentThickness === 12 ? 'bg-gray-200 ring-1 ring-gray-400 dark:bg-gray-600 dark:ring-gray-500' : 'hover:bg-gray-100 dark:hover:bg-gray-600'" class="w-6 h-6 flex items-center justify-center rounded transition"><svg width="14" height="14"><circle cx="7" cy="7" r="6" fill="currentColor" class="text-gray-700 dark:text-gray-200"/></svg></button>
            </div>
            ...
            <button type="button" @click="undo()" :disabled="history.length === 0" :class="history.length === 0 ? 'opacity-50 cursor-not-allowed' : 'hover:bg-gray-200 dark:hover:bg-gray-600'" class="text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-700 p-2 rounded-lg transition shadow-sm border border-gray-300 dark:border-gray-600 font-bold flex items-center gap-1" title="Stap terug">
            ...
            <button type="button" @click="reset()" class="text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 p-2 rounded-lg transition bg-white dark:bg-gray-700 shadow-sm border border-red-100 dark:border-red-900/30" title="Wis alles">
