        ...
        <div class="flex flex-col gap-4">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div>
                    ...
                    <div class="text-sm text-gray-500 dark:text-gray-400">Week {{ $weekNumber }} · {{ $weekLabel }}</div>
                </div>
            ...
            <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden p-6 space-y-4">
                ...
                @empty
                    <div class="text-center text-gray-500 dark:text-gray-400 py-8">Geen klanten gevonden.</div>
                @endforelse
            </div>
        </div>
    </div>
